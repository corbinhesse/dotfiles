...
" Vim Editor
call s:SetHighlight('ColorColumn', s:red, s:gray900, '')
call s:SetHighlight('CurSearch', 'none', s:yellow_diff_text, '')
...
call s:SetHighlight('MatchParen', s:caret, s:gray800, 'bold')
...
call s:SetHighlight('WinSeparator', s:gray700, 'none', '')
...
call s:SetHighlight('diffSubname', s:gray200, '', '')
...
call s:SetHighlight('fugitiveHunk', s:gray200, '', '')
...
call s:SetHighlight('CocExplorerFileDirectory', s:blue, 'none', 'bold')
...
call s:SetHighlight('CocExplorerGitIgnored', s:gray400, 'none', '')
